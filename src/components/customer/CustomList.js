...
const contentData = [
  {
    ...
    description: (
      <p style={{ fontFamily: "Nanum+Myeongjo" }}>
        ...
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>- 반납
        방법: 판매자와 채팅으로 시간을 정한 뒤 거래장소에서 만나서 식별코드를
        찍고 물건을 반납하면 됩니다. - 상품 등록: 상품을 등록하려면 로그인한
        후에 상품 등록 버튼을 클릭하고, 상품 정보를 입력한 후에 등록하시면
        됩니다.
  ...
  },
  {
    ...
    content: <h3>결제,취소,환불 어떻게 하나요</h3>,
    description: (
      <p>
        ...
        처리를 진행할 수 있습니다.
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>- 환불
        상세 내용은 아래와 같습니다: - 당일 ~ 3일 남을 때: 전체 대여금은
        환불되지 않습니다. - 4일 ~ 7일 남을 때: 대여금의 50%가 환불됩니다. - 7일
        이상 남을 경우: 무료로 예약을 취소할 수 있습니다.
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>- 다만,
        대여가 이미 시작된 경우에는 정책에 따라 결제 취소가 제한될 수 있습니다.
        <span style={{ display: `block`, margin: `0 9px 0 0` }}></span>
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        관리할 수 있습니다.
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>
        ==<span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>- 예약
        취소: 마이 페이지의 &#39;예약 내역&#39;에서 대여가 시작되지 않은
        상품들은 예약 취소가 가능합니다. 예약 취소를 원하는 경우, 해당 예약
        내역을 찾아 취소 옵션을 선택하면 간단한 절차를 통해 예약을 취소할 수
        있습니다. 다만, 대여가 이미 시작된 경우에는 정책에 따라 예약 취소가
        제한될 수 있습니다.
        <span style={{ display: `block`, margin: `0 9px 0 0` }}></span>
      </p>
    ),
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        확인하실 수 있습니다. - 회원 가입: 회원 가입 시에는 사용자의 개인 정보를
        안전하게 관리하기 위해 모든 필수 항목을 정확하게 기입하셔야 합니다.
        또한, 회원의 안전한 이용을 위해 본인인증을 꼭 완료해주셔야 합니다. 회원
        가입이 성공적으로 완료되면, 등록된 아이디와 비밀번호를 입력하여 로그인이
        가능해집니다. 로그인 후에는 마이 페이지의 회원정보 수정을 통해 추가
        정보를 입력하거나 프로필을 수정할 수 있습니다.
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>
        <span style={{ display: `block`, margin: `8px 8px 0 0` }}></span>- 회원
        탈퇴: 탈퇴 시에는 로그인 후 마이 페이지에서 회원탈퇴를 선택하여 간단하게
        탈퇴를 진행할 수 있습니다. 주의사항: 만약 아직 처리되지 않은 거래가
        남아있는 경우에는 탈퇴를 진행할 수 없습니다. 탈퇴 전에 이러한 사항을
        확인하시기 바랍니다.
        <span style={{ display: `block`, margin: `0 9px 0 0` }}></span>
      </p>
    ),
