  ...
  return (
    <PaginationContainer>
      <ul className="pagination pagination-md justify-content-end">
        ...
        <li className="page-item">
          <span className="page-link" onClick={() => handleButtonClick("prev")}>
            &lsaquo;
          </span>
        </li>
        {array.map(value => (
          <li
            key={value}
            className={`page-item ${props.page === value ? "active" : ""}`}
          >
            <span
              className="page-link"
        ...
        <li className="page-item">
          <span className="page-link" onClick={() => handleButtonClick("next")}>
            &rsaquo;
          </span>
        </li>
        <li className="page-item">
          <span className="page-link" onClick={() => handleButtonClick("last")}>
            &raquo;
          </span>
        </li>
      </ul>
